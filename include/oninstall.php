 ...
 */
function xoops_module_pre_install_statistics(\XoopsModule $module)
{
    include __DIR__ . '/../preloads/autoloader.php';
    /** @var Statistics\Utility $utility */
    $utility = new \XoopsModules\Statistics\Utility();
 ...
 */
function xoops_module_install_statistics(\XoopsModule $module)
{
