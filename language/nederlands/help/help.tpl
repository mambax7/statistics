<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/statistics/admin/index.php"
           title="Back to the administration of Statistics"> Statistics
            <img src="<{xoAdminIcons home.png}>"
                 alt="Back to the Administration of Statistics">
        </a></h1>
    ...
    <p class="even">1) First, follow the standard installation process –
