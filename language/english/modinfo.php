...
//define('_MI_STATISTICS_HELP_DIR', __DIR__);

//help multi-page
define('_MI_STATISTICS_DISCLAIMER', 'Disclaimer');
define('_MI_STATISTICS_LICENSE', 'License');
define('_MI_STATISTICS_SUPPORT', 'Support');
