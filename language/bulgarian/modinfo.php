...
define(
    '_MI_REFERERSPAMDSC',
    'Изберете тип контрол за СПАМЕРИТЕ.<br>' . '<b>Забранен</b> - Блокиран от Вашия сайт, не се отчита<br>' . '<b>Игнориране</b> - Блокиран от рефералите, но се отчита и е видим от администраторите<br>' . '<b>Рефлекция</b> - Пренасочва се към сайта на реферала<br>' . '<b>Разрешава</b> - Никакъв'
);
define('_MI_ALLOWFILTERIPHITSDSC', 'Ще включите ли филтрирането?');
define('_MI_FILTERIPLISTDSC', 'Въведете IP които не искате да бъдат отчитани като валидни посещения.<br>' . 'Въведете всеки ИП адрес разделен с <b>|</b><br>Пример: 111.222.333.444|555.666.777.888<br>' . 'Поддръжат се и вариации<br>' . 'Пример: ^111.222.333|111.222.333$|123[0-9]*');
define(
    '_MI_BOTIDENTITIESDSC',
    'Въведете име, термин, или * за да отчита различни ботове.<br>' . 'Ботове които не се индетифицирани не се отчитат <b>Неизвестни</b> от Вашия портал.<br>' . 'Въведете всеки бот разделен с <b>|</b><br>Поддържат се и вариации.' . '<br>Пример: bot|^spider|arch$|badbot[a-z]*'
);
define('_MI_FORBIDBOTSDSC', 'Ще включите ли блокирането на ботове до портала си?<br><i>Това само блокира ' . 'ботове описани в настройките на <b>Ботове за блокиране</b>.</i>');
define(
    '_MI_BOTSTOBLOCKDSC',
    'Това е активно само ако в настройките е избрано ДА за <b>Забранени ботове</b><br>'
...
define('_MI_AUTOPURGEREFERERDSC', 'Настройте тази опция на каквото и да е, без <b>Никога</b> тя ще изчиства списъците на определено време.<br>' . 'Пр. - Настроено е за 6 часа, всичко по-старо от 6 часа ще бъде изтривано.');
// Config Items values
...
define('_MI_STATISTICS_HOME', 'Home');
define('_MI_STATISTICS_ABOUT', 'About');
