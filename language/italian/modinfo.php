...
define("_MI_STATISTICS_NAME","Statistiche del Sito");

// A brief description of this module
define("_MI_STATISTICS_DESC","Statistiche del sito by IBDeeming!  Tracking visits, bots, browsers, and O/S versions.");

// Block SM Name
define("_MI_STATISTICS_SMNAME1","Statistiche");
define("_MI_STATISTICS_SMNAME2","Dettaglio Accessi");
define("_MI_STATISTICS_SMNAME3","Mostrs TUTTI i Referers");

// Block b name
define("_MI_STATISTICS_BNAME1", "Accessi al Sito");
define("_MI_STATISTICS_BNAME2", "Migliori Referers");

// Admin menus
define("_MI_STATISTICS_ADMENU2", "Imformazioni Generali PHP");
define("_MI_STATISTICS_ADMENU3", "PHP Credits" );
define("_MI_STATISTICS_ADMENU4", "Configurazione PHP");
define("_MI_STATISTICS_ADMENU5", "Moduli PHP");
define("_MI_STATISTICS_ADMENU6", "Ambiente PHP");
define("_MI_STATISTICS_ADMENU7", "Variabili PHP");
define("_MI_STATISTICS_ADMENU8", "Licenza PHP");
define("_MI_STATISTICS_ADMENU9", "Imformazioni complete di PHP");
define("_MI_STATISTICS_ADMENU10", "Indirizzo Remoto del Database");
